  ...
  return (
    <header className="flex w-full items-center justify-between pt-2 pb-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[#B08D2A] bg-[#0B2C1A] text-[#B08D2A] shadow-inner">
      ...
      <button 
        ...
        className="relative flex h-11 w-11 items-center justify-center rounded-2xl border border-[#B08D2A] bg-[#0B2C1A] text-emerald-100 transition-all hover:bg-[#123824] active:scale-95"
      >
